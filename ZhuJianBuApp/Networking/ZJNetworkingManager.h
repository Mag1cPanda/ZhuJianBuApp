...
@interface ZJNetworkingManager : NSObject
...
/**
 ...
 @param fail 失败回调
 */
+ (void)POST:(NSString *)serviceIP serviceName:(NSString *)serviceName params:(NSMutableDictionary *)params success:(ZJResponseSuccess)success
